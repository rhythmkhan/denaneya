        ...
        return jsonResponse(
          {
            ...
            amountPaisa: existing.amountPaisa.toString(),
            feePaisa: existing.feePaisa.toString(),
            refundedAmountPaisa: existing.refundedAmountPaisa.toString(),
            currency: existing.currency,
            status: existing.status,
            provider: existing.provider,
            providerTrxId: existing.providerTrxId,
